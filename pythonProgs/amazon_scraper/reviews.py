...
class Reviews(object):
    ...
    def next_page_url(self):
        ...
        anchor_list = self.soup.find_all('a', href=re.compile(r'product-reviews.*paging_btm_.*', flags=re.I))
        if anchor_list:
            return urlparse.urljoin(amazon_base, unicode(anchor_list[-1]['href']))
        return None
